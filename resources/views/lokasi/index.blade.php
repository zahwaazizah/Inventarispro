...
@section('page-title', 'Kelola Lokasi Barang')
@section('page-description', 'Kelola data lokasi penyimpanan barang inventaris')
...
<div class="row">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3>{{ $lokasis->where('created_at', '>=', now()->subDays(30))->count() }}</h3>
                <p>Lokasi Baru (30 hari)</p>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                <h3 style="margin: 0;"><i class="fas fa-list"></i> Daftar Lokasi</h3>
        ...
        <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $lokasi->created_at ? date('d/m/Y', strtotime($lokasi->created_at)) : '-' }}</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn-edit" onclick="editLokasi({{ $lokasi->id }}, '{{ $lokasi->nama_lokasi }}', '{{ addslashes($lokasi->deskripsi) }}')">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn-delete" onclick="hapusLokasi({{ $lokasi->id }}, '{{ $lokasi->nama_lokasi }}')">
            ...
            @else
                <div class="empty-state">
                    <i class="fas fa-map-marker-alt"></i>
                    <h4>Belum Ada Data Lokasi</h4>
                    <p>Silakan tambahkan lokasi terlebih dahulu</p>
        ...
        <form method="POST" id="formLokasi">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_lokasi" id="nama_lokasi" class="form-control" placeholder="Contoh: Gudang A, Ruang B201, Lab Komputer" required>
                </div>
                
                <div class="form-group">
                    <label>Deskripsi</label>
                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="3" placeholder="Deskripsi lokasi (opsional)"></textarea>
                </div>
            </div>
...
function hapusLokasi(id, nama) {
    if(confirm('Apakah Anda yakin ingin menghapus lokasi "' + nama + '"?\n\nLokasi yang memiliki barang tidak dapat dihapus.')) {
        const deleteForm = document.createElement('form');
        deleteForm.method = 'POST';
        deleteForm.action = '{{ url("lokasi") }}/' + id;
